...
class StoryConcept extends React.Component {
  renderImage = () => (
    <Image
      ...
      source={require('../../assets/explode.png')}
    />
  );
      ...
      <View style={styles.storyParentContainer}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.introText}>
            ...
            nearby, and we have marked their locations on your map. But be
            warned - you need to collect tools in the right order, because each
            tool helps you access another one. Collect all the items, then use
            them to disarm the bomb. Please hurry, time is running out!
          </Text>
          {this.renderImage()}
        </View>
